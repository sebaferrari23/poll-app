...
<header class="bg-white">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
      <a href="/" class="flex items-center justify-start lg:w-0 lg:flex-1">
        <img class="h-8 w-auto mr-5 sm:h-10" src="https://tailwindui.com/img/logos/workflow-mark-indigo-600.svg" alt="">
        <h1 class="text-black font-bold text-2xl">PollyApp</h1>
      </a>
      ...
      <nav class="hidden md:flex space-x-10">
        <a href="/polls" class="text-base font-medium text-gray-500 hover:text-gray-900">
          Browse Polls
        </a>
        <a href="/faqs" class="text-base font-medium text-gray-500 hover:text-gray-900">
          FAQs
        </a>
